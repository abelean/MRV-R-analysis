...
if ( dir.exists( file.path( figure_path, 'lin_markers' ) ) ) {
  cat("figure_path/lin_markers exists and is a directory.\n")
} else {
  cat("figure_path/lin_markers does not exist - creating.\n")
  dir.create( file.path( figure_path , 'lin_markers' ) )
}

if ( dir.exists( file.path( wd , 'results', 'figures', 'DN' ) ) ) {
  cat("results/figures/DN exists and is a directory.\n")
} else {
  cat("results/figures/DN does not exist - creating.\n")
  dir.create( file.path( wd , 'results', 'figures', 'DN' ) )
}
if ( dir.exists( file.path( wd , 'results', 'figures', 'DN' , 'variable_clusters' ) ) ) {
  cat("results/figures/DN/variable_clusters exists and is a directory.\n")
} else {
  cat("results/figures/DN/variable_clusters does not exist - creating.\n")
  dir.create( file.path( wd , 'results', 'figures', 'DN' , 'variable_clusters' ) )
}
if ( dir.exists( file.path( wd , 'results', 'figures', 'DN' , 'UMAP' ) ) ) {
  cat("results/figures/DN/UMAP exists and is a directory.\n")
} else {
  cat("results/figures/DN/UMAP does not exist - creating.\n")
  dir.create( file.path( wd , 'results', 'figures', 'DN' , 'UMAP' ) )
}
if ( dir.exists( file.path( wd , 'results', 'figures', 'DN' , 'Violin' ) ) ) {
  cat("results/figures/DN/Violin exists and is a directory.\n")
} else {
  cat("results/figures/DN/Violin does not exist - creating.\n")
  dir.create( file.path( wd , 'results', 'figures', 'DN' , 'Violin' ) )
}
if ( dir.exists( file.path( wd , 'results', 'figures', 'DN' , 'chosen_clusters' ) ) ) {
  cat("results/figures/DN/chosen_clusters exists and is a directory.\n")
} else {
  cat("results/figures/DN/chosen_clusters does not exist - creating.\n")
  dir.create( file.path( wd , 'results', 'figures', 'DN' , 'chosen_clusters' ) )
}
